            ...
            l = function (e) {
                ...
                s.init = function (e) {
                        if (u && (i = function () {
                            ...
                            i.scrollContainer && document.querySelector(i.scrollContainer) ? (document.querySelector(i.scrollContainer).addEventListener("scroll", this._scrollListener, !1), document.querySelector(i.scrollContainer).addEventListener("resize", this._scrollListener, !1)) : (document.addEventListener("scroll", this._scrollListener, !1), document.addEventListener("resize", this._scrollListener, !1));
                            var h = null;
...
function (e, t) {
    e.exports = function (e) {
        ...
        function s(t) {
                ...
                return t && (l += r + e.collapsibleClass, l += r + e.isCollapsedClass),
        ...
        return {
                ...
                render: function (e, t) {
                    ...
                    if (null !== o) return o.firstChild && o.removeChild(o.firstChild),
                ...
                updateToc: function (i) {
                    ...
                    if (l && null !== document.querySelector(e.tocSelector) && a.length > 0) {
                        n.call(a, function (t, n) {
                            return function t(n) {
                                var o = 0;
                                return n !== document.querySelector(e.contentSelector && null != n) && (o = n.offsetTop, e.hasInnerContainers && (o += t(n.offsetParent))),
                                o
        ...
        return {
            nestHeadingsArray: function (l) {
                return t.call(l, function (t, l) {
                    ...
                    return r &&
                    function (t, l) {
                        for (var r = o(t), i = r.headingLevel, s = l, c = n(s), a = i - (c ? c.headingLevel : 0); a > 0;)(c = n(s)) && void 0 !== c.children && (s = c.children),
                        a--;
